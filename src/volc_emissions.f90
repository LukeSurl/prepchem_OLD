...
! volume_m3            = volume_km3 * 1000**3     
  integer, parameter :: maxnspecies = 200 , nspecies = 19 
  integer, parameter ::         &
   ASH      = 1 & 
  ,SO2      = 2 &
  ,SULF     = 3 &
...
!   
  ...
  !print*,"DEBUG2 I think max(volc_prop(MHOBR) is", max(volc_prop(MHOBR)%volcano)
...
!print*,"DEBUG3 I think max(volc_prop(MHOBR) is", max(volc_prop(MHOBR)%volcano)
